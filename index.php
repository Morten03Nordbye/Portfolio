   ...
   <div class="d-flex flex-column">
    <div class="profile">
     ...
     <div class="social-links mt-3 text-center">
      ...
      <a class="linkedin" href="https://www.linkedin.com/in/morten-nordbye-325bb71bb/">
    ...
    <div class="container">
     ...
     <div class="row">
      ...
      <div class="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-left">
       ...
       <p class="fst-italic">
        As an apprentice at Basefarm/Orange Business Services, I have the opportunity to work with both Linux and Windows systems as part of our private cloud offering. This allows me to gain valuable experience and knowledge in two of the most widely used operating systems in the industry. Working in a private cloud environment presents unique challenges and opportunities, and I am constantly learning and growing as a result. I am grateful for the opportunity to be a part of this dynamic and innovative team.
       </p>
       <div class="row">
        <div class="col-lg-6">
         <ul>
    ...
    <div class="container">
     ...
     <div class="row">
      ...
      <div class="col-lg-4 col-md-6 icon-box" data-aos="fade-up" data-aos-delay="100">
       ...
       <p class="description">
        I have a passion for politics and enjoy learning about different political systems, ideologies, and current events. I think it's important to be informed about political issues in order to participate in democracy and make informed decisions. I also find discussions about politics engaging and stimulating. Overall, I think having an interest in politics is a rewarding pursuit.
       </p>
      </div>
      <div class="col-lg-4 col-md-6 icon-box" data-aos="fade-up" data-aos-delay="200">
       ...
       <p class="description">
        I am a big fan of gaming and have found it to be a great way to unwind and recharge. It's a fun and engaging activity that allows me to challenge myself and exercise my problem-solving skills. I find that playing games helps me relax and reduce stress, improving my productivity and overall well-being. Additionally, gaming can be a social activity, fostering teamwork and collaboration among colleagues.
       </p>
      </div>
    ...
    <div class="container">
     ...
     <div class="row skills-content">
      ...
      <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
       ...
       <div class="progress">
        <span class="skill">
         Telia Bedriftsnett Administration
         <i class="val">
          100%
         </i>
        </span>
     ...
     <div class="row">
      ...
      <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
	   ...
	   <div class="resume-item">
        ...
        <p>
         Operational oversight of private and public cloud systems, focusing on hardware to application layers within the OSI model. Demonstrated leadership in managing teams and applied ITIL framework in operations.
        </p>
       </div>
       <div class="resume-item">
        <h4>
        ...
        <ul>
         <li>
          Managed private cloud operations with an understanding of the OSI model, spanning from hardware to application layers.
         </li>
         <li>
          Maintained and optimized company's SMS system, including documentation, troubleshooting, efficiency improvements, and sourcing new gateways for improved redundancy.
         </li>
         <li>
          Served as a team lead for the Incident Team (INO) and Change Team (CNO), applying the ITIL framework in coordinating and managing team operations.
         </li>
         <li>
          As part of the maintenance team, acted as both Manager and Coordinator, ensuring the smooth execution of monthly upgrades without unexpected downtime.
         </li>
         <li>
       ...
       <div class="resume-item">
        ...
        <p>
         Teaching children about high-level block-based visual programming language
        </p>
       </div>
      </div>
     </div>
