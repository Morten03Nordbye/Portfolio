...
<body>
	...
	<i class="bi bi-list mobile-nav-toggle d-xl-none"></i> <!-- ======= Header ======= -->
	<header id="header">
		<div class="d-flex flex-column">
			...
			<nav class="nav-menu navbar" id="navbar">
				<ul>
					<li>
						<a class="nav-link scrollto active" href="#hero"><i class="bx bx-home"></i> <span>Home</span></a>
					</li>
					<li>
						<a class="nav-link scrollto" href="#about"><i class="bx bx-user"></i> <span>About</span></a>
					</li>
					<li>
	...
	<main id="main">
		...
		<section class="about" id="about">
			<div class="container">
				...
				<div class="row">
					<div class="col-lg-4" data-aos="fade-right"><img alt="" class="img-fluid" src="/assets/img/profile-img.jpg"></div>
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-lg-4 col-md-6 icon-box" data-aos="fade-up" data-aos-delay="400">
						...
						<h4 class="title"><a href="">Homelabing</a></h4>
					...
					<div class="col-lg-4 col-md-6 icon-box" data-aos="fade-up" data-aos-delay="500">
						...
						<h4 class="title"><a href="">Stocks and Investing</a></h4>
						<p class="description">I am passionate about stocks and investing, and I find the subject to be both fascinating and financially rewarding. I enjoy researching companies and analyzing financial data to make informed investment decisions. I think that investing in stocks is a smart way to grow and diversify one's wealth, and it allows for the potential to generate passive income. Additionally, being invested in the stock market allows me to stay informed about the economy and business developments. Overall, I think that having an interest in stocks and investing is a smart and rewarding pursuit.</p>
					</div>
				</div>
			</div>
				...
				<div class="row skills-content">
					<div class="col-lg-6" data-aos="fade-up">
						<div class="progress">
							...
							<div class="progress-bar-wrap">
								<div aria-valuemax="100" aria-valuemin="0" aria-valuenow="70" class="progress-bar" role="progressbar"></div>
							</div>
						</div>
						<div class="progress">
					...
					<div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
						<div class="progress">
							...
							<div class="progress-bar-wrap">
								<div aria-valuemax="100" aria-valuemin="0" aria-valuenow="60" class="progress-bar" role="progressbar"></div>
							</div>
						</div>
						<div class="progress">
						...
						<div class="progress">
							...
							<div class="progress-bar-wrap">
								<div aria-valuemax="100" aria-valuemin="0" aria-valuenow="100" class="progress-bar" role="progressbar"></div>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-lg-6" data-aos="fade-up">
						...
						<div class="resume-item pb-0">
							...
							<p><em>As a recent addition to the IT industry, I am eager to learn and grow in my career. I have experience working with both Windows and Linux systems and am dedicated to staying current with the latest industry trends and advancements. I am a hardworking and driven individual with a passion for problem-solving and implementing effective solutions. In my free time, I enjoy staying active and training. I am excited to begin this new chapter in my career and look forward to the opportunities and challenges ahead.</em></p>
							<ul>
								<li>Oslo, Norway</li>
								<li>+47 979 02 931</li>
					...
					<div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
						...
						<div class="resume-item">
							...
							<h5>4 uke</h5>
							<p><em>Elkjøp Ullevål AND Elkjøp skøyen , Oslo</em></p>
							<p>As a helpdesk representative at a tech shop, I was responsible for providing technical support to customers and assisting with troubleshooting issues related to their technology products. I worked closely with a team of technicians to diagnose and resolve customer inquiries, and I gained valuable experience in customer service and technical support. I also learned a lot about the latest technology products and trends, and I was able to apply this knowledge to help customers make informed purchasing decisions. Overall, working at the helpdesk was a challenging and rewarding experience that helped me develop my technical and customer service skills.</p>
							<ul></ul>
						</div>
						<div class="resume-item">
							<h4>Kodelærer for 4 klasse</h4>
							<h5>2018 - 2019</h5>
							<p><em>Oslo kommune</em></p>I had the opportunity to teach children about high-level block-based visual programming languages. Through hands-on activities and interactive lessons, I helped students understand the basics of coding and logic, and guided them as they worked on their own programming projects."
							<p></p>
						</div>
					</div>
				</div>
